...
public static class UserMessages
{
    ...
    public const string StudentNumberMustBe10Characters = "Öğrenci numarası 10 karakter olmalı.";
    ...
    public const string StudentNumberAlreadyExists = "Bu öğrenci numarası daha önce alınmış.";
